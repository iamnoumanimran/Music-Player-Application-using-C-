...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral("./Picture/import1.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon11;
        icon11.addFile(QStringLiteral("./Picture/lyrics.png"), QSize(), QIcon::Normal, QIcon::Off);
		pushButton->setObjectName(QStringLiteral("lyrics"));
        pushButton->setIcon(icon11);
        pushButton->setIconSize(QSize(40, 40));
        MainWindow->setCentralWidget(centralWidget);
		QIcon icon12;
		icon12.addFile(QStringLiteral("./Picture/sort.png"), QSize(), QIcon::Normal, QIcon::Off);
		sortAlgo = new QPushButton(centralWidget);
		sortAlgo->setObjectName(QStringLiteral("sort"));
		sortAlgo->setIcon(icon12);
		sortAlgo->setIconSize(QSize(27,27));
		sortAlgo->setCheckable(false);
		sortAlgo->setGeometry(QRect(300, 267, 40, 40));
		sortAlgo->setCursor(QCursor(Qt::PointingHandCursor));
